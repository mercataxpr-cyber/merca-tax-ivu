...
export function transformIndexSource(source) {
  ...
  output = output.replace('<link rel="apple-touch-icon" href="assets/apple-touch-icon.png">', '');
  output = output.replace(/<link rel="icon" href="data:image\/png;base64,[^"]+">/g, '');
