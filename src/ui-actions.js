/* MercaTax IVU PR — canonical UI actions and mobile-safe presentation helpers. */
...
/* Responsive report popup helper; canonicalized with UI actions. */
(function installResponsiveReportPopup() {
  'use strict';
